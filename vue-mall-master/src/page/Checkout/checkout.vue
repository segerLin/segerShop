        ...
        <div slot="content">
          <ul class="address-item-list clearfix">
            <li v-for="(item,i) in addList"
                :key="i"
                class="address pr"
                @click="setCheck(item.addressId)"
                :class="{checked:checkItem == item.addressId}">
           <span v-if="checkItem == item.addressId" class="pa">
...
<script>
  import { addressDel, productDet, payMent } from '/api/goods'
  ...
  export default {
    ...
    methods: {
      ...
      // 付款
      payment () {
        if (this.addList[this.checkItem] && this.addList[this.checkItem].userName && this.addList[this.checkItem].tel && this.addList[this.checkItem].streetName) {
          let params = {
            params: {
              userName: this.addList[this.checkItem].userName,
              userPhone: this.addList[this.checkItem].tel,
              address: this.addList[this.checkItem].streetName,
              userId: getStore('userId')
            }
          }
          payMent(
