...
public class OrderServiceImplTest {
    ...
    public void create() throws Exception {
        ...
        orderDTO.setBuyerName("code monkey");
        orderDTO.setBuyerAddress("网商路");
        orderDTO.setBuyerPhone("11111122222");
        ...
        OrderDTO result = orderService.create(orderDTO, OrderStatusEnum.NEW.getCode());
